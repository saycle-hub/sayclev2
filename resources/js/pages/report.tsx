...
const input = 'mt-2 min-h-12 w-full rounded-xl border border-[#18352a]/15 bg-white px-4 outline-none focus:border-[#e88c12] focus:ring-2 focus:ring-[#e88c12]/20';
