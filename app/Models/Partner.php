...
class Partner extends Model
{
    ...
    protected $fillable = ['user_id', 'name', 'address', 'grade_preference', 'min_capacity_kg', 'ideal_capacity_kg', 'max_capacity_kg', 'frequency', 'receiving_days', 'monthly_receiving_day', 'overcapacity_terms_version', 'overcapacity_terms_accepted_at'];
