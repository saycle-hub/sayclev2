...
class PhaseFourFeatureTest extends TestCase
{
    ...
    {
        $paused = $this->contract('harian'); $paused->update(['status' => 'paused']);
    ...
    {
        $line = $this->deliveryWithLine(10); $delivery = $line->delivery; $vehicle = Vehicle::create(['name' => 'Truck', 'capacity_kg' => 10, 'is_active' => true]); $officer = User::factory()->create(['role' => 'officer']); $admin = $this->admin();
    ...
    {
        $contract = $this->contract('harian'); $contract->update(['status' => 'cancelled']);
    ...
    {
        $line = $this->deliveryWithLine(2); $delivery = $line->delivery; $vehicle = Vehicle::create(['name'=>'Off','capacity_kg'=>2,'is_active'=>false]); $admin=$this->admin();
    ...
    {
        $line=$this->deliveryWithLine(2,'released'); $vehicle=Vehicle::create(['name'=>'Truck','capacity_kg'=>2,'is_active'=>true]); $officer=User::factory()->create(['role'=>'officer']);
    ...
    {
        $line=$this->deliveryWithLine(10); $vehicle=Vehicle::create(['name'=>'Truck','capacity_kg'=>6,'is_active'=>true]); $officer=User::factory()->create(['role'=>'officer']); $admin=$this->admin();
    ...
    {
        $line=$this->deliveryWithLine(5); $vehicle=Vehicle::create(['name'=>'Truck','capacity_kg'=>5,'is_active'=>true]); $officer=User::factory()->create(['role'=>'officer']);
    ...
    {
        $line=$this->deliveryWithLine(2); $line->delivery->update(['status'=>'delivered']); $vehicle=Vehicle::create(['name'=>'Truck','capacity_kg'=>2,'is_active'=>true]); $officer=User::factory()->create(['role'=>'officer']);
    ...
    public function test_one_assignment_conserves_shared_reservation_across_delivery_lines(): void
    {
        ...
        $vehicle=Vehicle::create(['name'=>'Shared reservation truck','capacity_kg'=>20,'is_active'=>true]); $officer=User::factory()->create(['role'=>'officer']); $admin=$this->admin();
